...
exports.init = function(option){
	...
	fs.exists( './java' , function(exists){		
		    if(!exists)
		    {
		        if(exports.stats)
		        {
		        	console.log('INFO: '.cyan + 'java temp folder created'.cyan )
		        }		    	
		    	fs.mkdirSync('./java');
		    }
	});
...
exports.flushJava = function(){
	path = './java';
	fs.rmdir(path,function(err){
		if(err){
			console.log(err);
		}else{
			console.log("Successfully removed Java Temp Folder");
			init();
		}
	});
}
